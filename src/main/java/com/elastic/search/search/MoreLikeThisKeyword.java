...
public class MoreLikeThisKeyword {

	public static void main(String[] args) {
		new MoreLikeThisKeyword().run();
	}
	...
	public void run() {
		...
		try {
			...
			MoreLikeThisQueryBuilder builder = QueryBuilders.moreLikeThisQuery().likeText("spring seasar cobol")
